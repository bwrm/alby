...
ADMINS = [("Siarhei S", 'a@alby.by')]

# SECURITY WARNING: in production, inject the secret key through the environment
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY', '5LfXIFrnkWa8D42pYTesOletR0tKEQuNB8NXyrt5TNyRDrqx8VnOXpdRdVf5sRyx')
...
AUTH_USER_MODEL = 'phoneauth.User'
...
MIDDLEWARE = [
    ...
    'django.con trib.messages.middleware.MessageMiddleware',
...
STATICFILES_FINDERS = [
    ...
    'alby.finders.FileSystemFinder',
    # or 'django.contrib.staticfiles.finders.AppDirectoriesFinder',
    'alby.finders.AppDirectoriesFinder',
...
SHOP_PRODUCT_SUMMARY_SERIALIZER = 'alby.serializers.ProductSummarySerializer'
############################################
...
CMSPLUGIN_CASCADE = {
    ...
    'plugins_with_extra_render_templates': {
        'CustomSnippetPlugin': [
            ...
            # ('alby/catalog/manufacturer-filter.html', _("Manufacturer Filter")),
        ],
        # required to purchase real estate
        'ShopAddToCartPlugin': [
            (None, _("Default")),
            ('alby/catalog/commodity-add2cart.html', _("Add Commodity to Cart")),
        ],
    },
...
SHOP_CASCADE_FORMS = {
    'CustomerForm': 'alby.forms.checkout.CustomerForm',
...
PHONE_VERIFICATION = {
    ...
    'OPTIONS': {
        'SID': 'SKa93b8d69d9baff4746982fb3b31da93e',
        'SECRET': 'DZrRxIQKw0D5ox37c8dzmD57o6olh25F',
        'FROM': '+13344580572',
        'SANDBOX_TOKEN':'88fb8e4a0dc6c85d34347980f12453b0',
        # key type standart
    },
    'TOKEN_LENGTH': 4,
    ...
    'VERIFY_SECURITY_CODE_ONLY_ONCE': False,  # If False, security code can be used multiple times for verification
}
